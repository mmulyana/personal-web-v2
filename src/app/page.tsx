  ...
  return (
    <div className='mt-14 md:mt-24'>
      <div className='flex items-center justify-between'>
        <Signal text='Available for internship' type='primary' />
      ...
      <p className='text-white/80 max-w-[610px] mt-6 text-sm'>Junior front-end developer based in Indonesia specializing in crafting highly responsive and visually appealing user interfaces for seamless user experiences.</p>
      {/* {posts.map((post) => (
